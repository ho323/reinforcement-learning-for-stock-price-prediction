...
if __name__ == '__main__':
    ...
    parser.add_argument('--stock_code', nargs='+')  # 강화학습의 환경이 될 주식의 종목 코드입니다. A3C이 경우 여러 개의 종목 코드를 입력합니다.
    parser.add_argument('--ver', choices=['v1', 'v2', 'v3'], default='v3')  # RL Trader이 버전을 명시합니다. 기본값으로 v3을 사용합니다.
    parser.add_argument('--rl_method', choices=['dqn', 'pg', 'ac', 'a2c', 'a3c', 'monkey'])  # 강화학습 방식을 설정합니다. dqn, pg, ac, a2c, a3c, monkey 중에서 하나를 정합니다.
    ...
    parser.add_argument('--start_epsilon', type=float, default=0)  # 시작 탐험율을 정합니다. 에포크가 수행되면서 탐험률은 감소합니다. 1. 0.5 등으로 정할 수 있습니다.

...
if __name__ == '__main__':
    ...
    parser.add_argument('--stock_code', nargs='+', default=['035420'])  # 강화학습의 환경이 될 주식의 종목 코드입니다. A3C이 경우 여러 개의 종목 코드를 입력합니다.
    parser.add_argument('--ver', choices=['v1', 'v2', 'v3'], default='v2')  # RL Trader이 버전을 명시합니다. 기본값으로 v3을 사용합니다.
    parser.add_argument('--rl_method', choices=['dqn', 'pg', 'ac', 'a2c', 'a3c', 'monkey'], default='dqn')  # 강화학습 방식을 설정합니다. dqn, pg, ac, a2c, a3c, monkey 중에서 하나를 정합니다.
    ...
    parser.add_argument('--start_epsilon', type=float, default=0.5)  # 시작 탐험율을 정합니다. 에포크가 수행되면서 탐험률은 감소합니다. 1. 0.5 등으로 정할 수 있습니다.
    parser.add_argument('--balance', type=int, default=10000000)  # 주식투자 시뮬레이션을 위한 초기 자본금을 설정합니다. 
    parser.add_argument('--num_epoches', type=int, default=10000)  # 수행할 에포크 수를 지정합니다. 100, 1000 등으로 정할 수 있습니다. 
    ...
    for stock_code in args.stock_code:
        ...
        max_trading_unit = 1000 # max(int(1000000 / chart_data.iloc[-1]['close']), 1)

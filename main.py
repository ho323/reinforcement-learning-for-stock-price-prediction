...
if __name__ == '__main__':
    ...
    parser.add_argument('--stock_code', nargs='+', default=['005930'])  # 강화학습의 환경이 될 주식의 종목 코드입니다. A3C이 경우 여러 개의 종목 코드를 입력합니다.
    ...
    parser.add_argument('--num_epoches', type=int, default=300)  # 수행할 에포크 수를 지정합니다. 100, 1000 등으로 정할 수 있습니다. 
    ...
    for stock_code in args.stock_code:
        ...
        max_trading_unit = 100 # max(int(1000000 / chart_data.iloc[-1]['close']), 1)
